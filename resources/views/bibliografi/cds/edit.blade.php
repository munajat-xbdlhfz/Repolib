...
@section('content')
    @include('users.partials.header', ['title' => __('Edit CD Data')])   
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" method="post" action="/bibliografi/cd/edit/{{ $biblio->bibliografi_id }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('anak_judul') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="anak_judul" id="input-anak_judul" class="form-control form-control-alternative{{ $errors->has('anak_judul') ? ' is-invalid' : '' }}" placeholder="{{ __('Anak Judul') }}" value="{{ old('judul', $biblio->anak_judul) }}">
                                ...
                                <div class="form-group{{ $errors->has('isbn') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="isbn" id="input-isbn" class="form-control form-control-alternative{{ $errors->has('isbn') ? ' is-invalid' : '' }}" placeholder="{{ __('ISBN') }}" value="{{ old('isbn', $biblio->isbn) }}">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('jumlah_keping') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="jumlah_keping" id="input-jumlah_keping" class="form-control form-control-alternative{{ $errors->has('jumlah_keping') ? ' is-invalid' : '' }}" placeholder="{{ __('Jumlah Keping') }}" value="{{ old('jumlah_keping', $biblio->jumlah_keping) }}">
                                        ...
                                        <div class="input-group pb-3">
                                            <select class="custom-select" name="genre" id="genre">
                                                ...
                                                @foreach ($genre as $gnre)
                                                    @if (old('genre', $biblio->genre_id) == $gnre->id)
                                                        <option value="{{ $biblio->genre_id }}" selected>{{ $gnre->genre }}</option>
                                                    @else
                            ...
                            <h6 class="heading-small text-muted pt-5 mb-4">{{ __('Songwiter Information') }}</h6>
                            <div class="pl-lg-4">
                                {{-- PENCIPTA --}}
                                <div class="form-group">
                                        ...
                                        <div class="input-group pb-3">
                                            <select class="custom-select" name="songwriter" id="songwriter">
                                                ...
                                                @foreach ($pencipta as $cipta)
                                                    @if (old('songwriter', $biblio->pencipta_id) == $cipta->id)
                                                        <option value="{{ $biblio->pencipta_id }}" selected>{{ $cipta->name }}</option>
                                                    @else
